      ...
      <Content contentContainerStyle={styles.content}>
        ...
        <View style={{ marginTop: 16, marginBottom: 40, width: '100%', height: 220, backgroundColor: 'black', borderRadius: 16, backgroundColor: "#3D195B", justifyContent: 'center', paddingHorizontal: 16, paddingTop: 32, paddingBottom: 40 }}>
          <VStack gap={40}>
            ...
            <HStack ph={8} mb={10}>
              <HStack gap={8} justify={'start'} onStartShouldSetResponder={() => { setCurrent('appCards') }} style={{ width: '50%' }}>
                <Text style={{ alignSelf: 'center', color: 'white' }}>Points</Text>

                <View style={{ borderWidth: 1, borderColor: 'white', borderRadius: 12, paddingHorizontal: 16 }}>
